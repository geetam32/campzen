...
import { ArrowLeft, Star, Users, MessageSquare } from 'lucide-react-native';
...
const AdminFeedback = ({ navigation }) => {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.feedbackCard}>
            <View style={styles.cardHeader}>
                <View style={styles.studentInfoRow}>
                    ...
                    <View>
                        ...
                        <Text style={styles.studentMeta}>{item.studentPin} • {item.classId}</Text>
                    </View>
                </View>
            ...
            <View style={[styles.starsSmall, { marginVertical: 8, gap: 4 }]}>
                {[1, 2, 3, 4, 5].map(s => (
                    <Star
                        key={s}
                        size={12}
            ...
            {item.remark ? (
                ...
                <Text style={styles.emptyRemark}>No written remark provided</Text>
            )}
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    teacherChip: { backgroundColor: '#fff', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, marginRight: 10, borderWidth: 1, borderColor: '#e2e8f0' },
    ...
    studentMeta: { fontSize: 11, color: '#64748b', fontWeight: '600' },
